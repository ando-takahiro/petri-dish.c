// based on this
// https://github.com/coolaj86/libev-examples/blob/756021d3275ccc1c855743d162d169185e2eaf53/src/unix-echo-client.c
#include <errno.h>
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
static void connection_new(EV_P_ int port) {
  struct sockaddr_in addr;

  if (-1 == (remote_fd = socket(PF_INET, SOCK_STREAM, 0))) {
    perror("socket");
    exit(1);
  }
  ...
  if (-1 == connect(remote_fd, (struct sockaddr *)&addr, sizeof addr)) {
    perror("connect");
    //exit(1);
  }
}
